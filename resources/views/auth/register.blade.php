  ...
  <div class="col-md-5">
   <div class="card">
     <h2 class="card-title text-center">@lang('messages.account.register')</h2>
      <div class="card-body py-md-4">
       <form _lpchecked="1"  action="{{ route('confirm') }}" method="POST" enctype="multipart/form-data">
       @csrf
          <div class="form-group">
              <input type="text" id="name" class="form-control"value="{{$data['firstname']??''}}" name="firstname" placeholder="first name" required autofocus>
                                  @if ($errors->has('firstname'))
                                      <span class="text-danger">{{ $errors->first('firstname') }}</span>
                                  @endif  
        </div>
        <div class="form-group">
              <input type="text" id="name" class="form-control"value="{{$data['lastname']??''}}" name="lastname" placeholder="last name" required autofocus>
        ...
        <div class="form-group">
           <input type="text" id="email" class="form-control" value="{{$data['email']??''}}"placeholder="Email" name="email" required autofocus>
                            ...
                            @if ($errors->has('email'))
                                  ...
                                  @endif                            
        <div class="form-group">
            <input type="password" id="password" class="form-control" value="{{$data['password']??''}}" placeholder="Password" name="password" required>
                                    
        </div>
        <div class="form-group">
            <input type="password" id="password" class="form-control" value="{{$data['password']??''}}" placeholder="Re-Password" name="cf_password" required>
   ...
   <div class="d-flex flex-row align-items-center justify-content-between">
      <a href="{{route('login')}}">Login</a>
       ...
       <script src="{{asset('assets/css/js/Address.js')}}"></script>
...
<script>
var urlAddress = '{{route('register.district')}}';
