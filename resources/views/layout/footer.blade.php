 <!-- partial:partials/_footer.html -->
        <footer class="footer">
          ...
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Distributed by <a href="https://www.themewagon.com/" target="_blank">Intern-HongPhan</a></span> 
          </div>
        </footer> 
        <!-- partial -->
          <!-- plugins:js -->
